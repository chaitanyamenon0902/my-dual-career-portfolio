export function Footer() {
    return (<footer className="px-6 sm:px-12 lg:px-20 py-16 max-w-7xl mx-auto text-center">
      ...
      <a href="/resume.pdf" download className="mt-10 inline-flex items-center gap-2 rounded-full border border-border bg-card px-5 py-2.5 text-sm hover:border-primary hover:text-primary transition-colors">
